...
class TestCadastroAutor():
  ...
  def teste_CadastroAutor_falha(self):
    ...
    sleep(2)
    # preencher os campos
    driver.find_element(By.ID, "id_nome").send_keys("José de Abreu")
    ...
    sleep(2)
    # valida se apresentou erros na inclusão do registro
    assert driver.find_element(By.CSS_SELECTOR, ".errorlist > li").text == "Autor com este Nome do autor já existe."
    #assert driver.find_element(By.CSS_SELECTOR, ".errorlist > li").text == "A idade mínima permitida é de 5 anos."
    #assert driver.find_element(By.CSS_SELECTOR, ".errorlist > li").text == "Não existe data de nascimento futura."