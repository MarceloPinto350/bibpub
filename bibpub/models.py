...
class Pessoa (models.Model):
    ...
    class Meta:
        ...
        permissions = [
            ("can_view_pessoa", "Pode ver pessoas"),
            ("can_change_pessoa", "Pode alterar pessoas"),
            ("can_add_pessoa", "Pode adicionar pessoas"),
            ("can_delete_pessoa", "Pode apagar pessoas"),
        ]
...
class Obra(models.Model):
    ...
    titulo = models.CharField("Título da obra", max_length=200, null=False, unique=True)
